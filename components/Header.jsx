          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 pr-32">
            {user ? (
              <>
                <a
                  href="/dashboard"
                  className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-yellow-400 rounded-md shadow-sm text-base font-medium text-yellow-400 bg-white hover:bg-yellow-400 hover:text-white"
                >
                  Dashboard
                </a>
                <a
